      ...
      <div class="col-md-8 mx-auto">
        <form _lpchecked="1">
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                <input type="tel" class="form-control" placeholder="Enter your Date of birth">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <input type="url" class="form-control" placeholder=" Enter Your address">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <input type="url" class="form-control" placeholder="Enter Your NIC number">
              </div>
            </div>
