            ...
            <div class="col-md-8 mx-auto">
                <form _lpchecked="1">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="url" class="form-control" placeholder="Enter Price">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="tel" class="form-control" placeholder="Enter Catogeries">
                            </div>
                        </div>
                    ...
                    <div class="text-center mt-3">
                        <button class="btn btn-info"> AddProduct </button>
                    </div>
                </form>
            </div>
        </div>
